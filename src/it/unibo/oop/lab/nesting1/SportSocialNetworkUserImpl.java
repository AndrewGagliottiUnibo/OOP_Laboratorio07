...
public class SportSocialNetworkUserImpl<U extends User> extends SocialNetworkUserImpl<U> {
    ...
    static {
        ...
        F1 = new Sport("Formula 1 pilot");
        MOTOGP = new Sport("Moto GP pilot");
    ...
    public static final class Sport {
        ...
        public Sport(final String string) {
            this.name = string;
        }

        @Override
        public boolean equals(final Object o) {
            //spotbug mi segnalava che non controllavo un possibile valore null
            if (o == null) {
                return false;
            }
